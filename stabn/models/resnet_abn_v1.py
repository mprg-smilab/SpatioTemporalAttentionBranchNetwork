...
ST-ABN with 3D-ResNet backbone.
...
def abn_resnet18(pretrain_2d=False, **kwargs):
...
def abn_resnet34(pretrain_2d=False, **kwargs):
...
def abn_resnet50(pretrain_2d=False, **kwargs):
...
def abn_resnet101(pretrain_2d=False, **kwargs):
...
def abn_resnet152(pretrain_2d=False, **kwargs):
    """Constructs an Attention Branch Network with 3D ResNet-101 model."""
...
if __name__ == '__main__':
    ...
    model18 = abn_resnet18(pretrain_2d=True, num_classes=n_class, sample_duration=frame_length, dropout_ratio=d_ratio)
    output18 = model18(input)
    print(output18[0].size(), output18[1].size(), output18[2].size(), output18[3].size())

    model34 = abn_resnet34(pretrain_2d=True, num_classes=n_class, sample_duration=frame_length, dropout_ratio=d_ratio)
    output34 = model34(input)
    print(output34[0].size(), output34[1].size(), output34[2].size(), output34[3].size())

    model50 = abn_resnet50(pretrain_2d=True, num_classes=n_class, sample_duration=frame_length, dropout_ratio=d_ratio)
    output50 = model50(input)
    print(output50[0].size(), output50[1].size(), output50[2].size(), output50[3].size())

    model101 = abn_resnet101(pretrain_2d=True, num_classes=n_class, sample_duration=frame_length, dropout_ratio=d_ratio)
    output101 = model101(input)
    print(output101[0].size(), output101[1].size(), output101[2].size(), output101[3].size())

    model152 = abn_resnet152(pretrain_2d=True, num_classes=n_class, sample_duration=frame_length, dropout_ratio=d_ratio)
